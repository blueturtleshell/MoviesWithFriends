...
class CustomWatchGroupView: UIView {
    ...
    let mediaTitleTextField: UITextField = {
    ...
    private func setupView() {
        ...
        contentView.addSubview(mediaTitleTextField)
        ...
        mediaTitleTextField.snp.makeConstraints { make in
            make.top.equalTo(typeSegmentedControl.snp.bottom).offset(12)
        ...
        groupNameTextField.snp.makeConstraints { make in
            make.top.equalTo(mediaTitleTextField.snp.bottom).offset(12)
            make.left.equalToSuperview().offset(12)
            make.right.equalToSuperview().inset(12)
            make.height.equalTo(44)
        }
